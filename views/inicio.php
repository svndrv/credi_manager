<section>
    <article id="arti-home" class="bg-primary">
        <div id="cover-home" class="text-center">
            <h1>Bienvenidos</h1>
            <p>Somos la empresa Buró Group, en colaboración con <span id="credi">Credi</span><span id="scotia">Scotia</span> nos dedicamos a ofrecer asesoría financiera de alta calidad a nuestros clientes</p>
            <a href="login.php" class="login-button">Más información</a>
        </div>
    </article>
</section>
