    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="editar-carteraModalLabel">Transladar a Ventas</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="tem_car" name="tem" aria-describedby="emailHelp" value="0.00">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label for="credito_max" class="form-label">Credito:</label>
                                <input type="text" class="form-control" id="credito_car" name="credito" value="0.000">
                            </div>
                            <div class="mb-3">
                                <label for="linea" class="form-label">Linea:</label>
                                <input type="text" class="form-control" id="linea_car" name="linea" value="0.000">
                            </div>
                            <div class="mb-3">
                                <label for="plazo_max" class="form-label">Plazo:</label>
                                <select class="form-select" name="plazo" id="plazo_max_car">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="tipo_producto" id="tipo_producto_car">
...
<div class="modal fade" id="agregar-cartera" tabindex="-1" aria-labelledby="agregar-carteraModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="agregar-carteraModalLabel">Transladar a Ventas</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
